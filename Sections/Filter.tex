...
L und C Netzwerke haben geringste Bauteiltoleranzen. Die Struktur unterscheidet sich nicht zwischen den \textbf{Allpolfiltern}. Fpr Cauer Filter siehe \script{415}
\begin{center}
	\includegraphics[width=\columnwidth]{Images/struktur}
\end{center}

Die Bauteilgrössen können in der Tabelle 7.29 auf \script{410} ff. entnommen werden. Diese müssen noch \textbf{entnormiert} werden. Wobei $L_{FI}$ und $ C_{FI}$ aus der Tabelle genommen wurden.
\[
